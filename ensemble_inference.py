...
def normalize(means, stds, test_dataset):
	...
	for i in range(num_channels):
		features = test_dataset.features_per_sample[:,i * num_features : i * num_features + num_features - one_hot_len]
		...
		one_hot = test_dataset.features_per_sample[:,i * num_features + num_features - one_hot_len: i * num_features + num_features]
